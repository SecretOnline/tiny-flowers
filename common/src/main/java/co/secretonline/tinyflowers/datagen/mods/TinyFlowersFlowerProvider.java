	...
	public List<Flower> getFlowers() {
		return List.of(
			...
			Flower.Builder
				...
				.addTransformDayNightBehavior(When.NIGHT, TinyFlowers.id("tiny_open_eyeblossom"), 16545810,
			...
			Flower.Builder
				...
				.untintedStem()
				.stemTexture(TinyFlowers.id("tiny_eyeblossom_stem"))
				.addTransformDayNightBehavior(When.DAY, TinyFlowers.id("tiny_closed_eyeblossom"), 6250335,
