...
public class ModRecipeSerializers {
	public static Supplier<RecipeSerializer<TinyFlowerStewRecipe>> TINY_FLOWER_STEW = Services.REGISTRY.register(
		BuiltInRegistries.RECIPE_SERIALIZER,
		TinyFlowers.id("crafting_special_tiny_flower_stew"),
		() -> TinyFlowerStewRecipe.SERIALIZER);

	public static Supplier<RecipeSerializer<ShearTinyFlowersRecipe>> SHEAR_TINY_FLOWERS = Services.REGISTRY.register(
		BuiltInRegistries.RECIPE_SERIALIZER,
