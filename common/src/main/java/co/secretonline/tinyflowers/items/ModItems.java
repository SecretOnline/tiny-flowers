...
public class ModItems {
	...
	public static final Supplier<Item> FLORISTS_SHEARS_ITEM = Services.REGISTRY.registerItem(
		FLORISTS_SHEARS_ID,
	...
	public static final Supplier<Item> TINY_FLOWER_ITEM = Services.REGISTRY.registerItem(
		TINY_FLOWER_ID,
		() -> new TinyFlowerItem(
			new Item.Properties()
